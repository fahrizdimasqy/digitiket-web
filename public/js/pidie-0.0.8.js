...
class Pidie {
    ...
    countries() {
        return [{
            ...
            },
            {
                ...
                name: 'Benin',
                currency_code: 'XOF',
                currency_name: 'West Africa Franc',
                phone: '+229',
                language_code: 'fr',
            ...
            },
            {
                ...
                name: 'Cuba',
                currency_code: 'CUC',
                currency_name: 'Convertible Peso',
                phone: '+53',
                language_code: 'es',
                language_name: 'Español',
                demonym: 'Cuban'
    ...
    tryitLike(editor) {
        ...
        menusave.addEventListener('click', function (e) {
            ...
            var svTeksBlob = new Blob([svTeks], {
                type: 'text/html'
            });
    ...
    productImage() {
        ...
        function moveImage(e) {
            ...
            var h = '150';
            var bw = 3;
            if (x > zoomImageProduct.width - (w / zoom)) {
                x = zoomImageProduct.width - (w / zoom);
            }
            if (x < w / zoom) {
                x = w / zoom;
            }
            if (y > zoomImageProduct.height - (h / zoom)) {
                y = zoomImageProduct.height - (h / zoom);
            }
            if (y < h / zoom) {
                y = h / zoom;
            }
    ...
    imageMagnifier(options = {}) {
        ...
        function moveMagnifier(e) {
            ...
            x = pos.x;
            y = pos.y;
            if (x > img.width - (w / settings.zoom)) {
                x = img.width - (w / settings.zoom);
            }
            if (x < w / settings.zoom) {
                x = w / settings.zoom;
            }
            if (y > img.height - (h / settings.zoom)) {
                y = img.height - (h / settings.zoom);
            }
